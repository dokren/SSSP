    ...
    while not hp.is_empty():
        ...
        for neighbour in graph[vertex]:
            ...
            if distance[neighbour] == 'inf' or dist < distance[neighbour]:
                ...
                if hp.key_in(okey):
                    hp.change_val(okey, (dist, neighbour))
                else:
                    hp.insert((dist, neighbour))
...
class BinHeap:
    ...
    def del_min(self):
        ...
        self.hmap.pop(retval)
        self.heapList[1] = self.heapList[self.currentSize]
        self.hmap[self.heapList[1]] = 1
        self.currentSize -= 1
        self.heapList.pop()
        self.perc_down(1)
        return retval
